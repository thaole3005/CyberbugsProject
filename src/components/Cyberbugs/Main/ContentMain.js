...
import { GET_TASK_DETAIL_SAGA } from './../../../redux/constants/Cyberbugs/TaskConst/TaskConst';
...
export default function ContentMain(props) {
  ...
  const renderCardTaskList = () => {
    return projectDetail.lstTask?.map((taskListDetail, index) => {
      return (
        <div className="card" key={index} style={{ width: "17rem", height: "auto" }}>
                        ...
                        >
                          ...
                          <div className="block" style={{ display: "flex" }}>
                            <div className="block-left">
                              <h6>Priority: <p className = "text-danger">{task.priorityTask.priority}</p></h6>
                            </div>
